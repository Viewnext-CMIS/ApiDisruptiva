...
<<<<<<< HEAD
	...
	private static final String SERVER = "http://localhost:8080/chemistry-opencmis-server-fileshare/browser";
	private static final String REPOSITORY_ID ="test";
	private static final String TEST_TXT = "test.txt";
	static Session session = null;
	final static String carpetaPadre = "Sergio";
	final static String nombreDoc = "PruebasCambio";
...
>>>>>>> branch 'master' of https://github.com/Viewnext-CMIS/ApiDisruptiva.git
